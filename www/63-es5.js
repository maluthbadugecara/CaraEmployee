        ...
        regeneratorRuntime.mark(function _callee2() {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                if (_this2.mutationO) {
                  _this2.mutationO.disconnect();

                  _this2.mutationO = undefined;
                }

                _context2.next = 3;
                return _this2.getSwiper();

              case 3:
                swiper = _context2.sent;
                swiper.destroy(true, true);
                _this2.swiper = new Promise(resolve => {
                  _this2.readySwiper = resolve;
                });
                _this2.swiperReady = false;
        ...
        regeneratorRuntime.mark(function _callee3() {
          ...
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Promise.all([_this3.getSwiper(), waitForSlides(_this3.el)]);
        ...
        regeneratorRuntime.mark(function _callee18() {
          return regeneratorRuntime.wrap(function _callee18$(_context18) {
            while (1) switch (_context18.prev = _context18.next) {
              case 0:
                return _context18.abrupt("return", _this18.swiper);
        ...
        regeneratorRuntime.mark(function _callee19() {
          ...
          return regeneratorRuntime.wrap(function _callee19$(_context19) {
            while (1) switch (_context19.prev = _context19.next) {
              case 0:
                finalOptions = _this19.normalizeOptions(); // init swiper core
                // @ts-ignore
              ...
              case 3:
                ...
                Swiper = _ref3.Swiper;
                _context19.next = 7;
                return waitForSlides(_this19.el);

              case 7:
                swiper = new Swiper(_this19.el, finalOptions);
                _this19.swiperReady = true;

                _this19.readySwiper(swiper);
