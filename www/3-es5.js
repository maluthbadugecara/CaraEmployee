  ...
  function node_modulesIonicCoreDistEsmIonAlertIosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const Alert = class {
      ...
      renderCheckbox(labelledby) {
        ...
        }, inputs.map(i => Object(_core_feeeff0d_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
      ...
      renderInput(labelledby) {
        ...
        return Object(_core_feeeff0d_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          ...
          "aria-labelledby": labelledby
        }, inputs.map(i => Object(_core_feeeff0d_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      ...
      renderAlertButtons() {
        ...
        }, buttons.map(button => Object(_core_feeeff0d_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
      ...
      render() {
        const overlayIndex = this.overlayIndex,
              header = this.header,
